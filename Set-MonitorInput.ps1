...
if ($inputChoice -eq "HDMI1" -OR $inputChoice -eq "Laptop" ){
    Set-HDMI1
}
elseif ($inputChoice -eq "HDMI2" -OR $inputChoice -eq "Desktop"){
    Set-HDMI2
}
